...
enum {
	START_SCREEN = 0, STARTUP_GAME, INGAME,ENDGAME
};
enum{
	SUB_NONE = 0, IG_VILLAGEMENU,SS_SERVER,SS_OPTION, IG_ARMYOPTION, IG_MOVEARMY, IG_ASSEMBLYPOINT, IG_RECRUITOPTION,EG_WIN
};
enum{
